                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="fday">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <img src="{{url('images/program-img1.jpg')}}" class="img-responsive" alt="program">
                            </div>
                            ...
                            <!-- program speaker here -->
                            <div class="col-md-2 col-sm-2">
                                <img src="{{url('images/program-img2.jpg')}}" class="img-responsive" alt="program">
                            </div>
                            <div class="col-md-10 col-sm-10">
                                <h6>
                            ...
                            <!-- program speaker here -->
                            <div class="col-md-2 col-sm-2">
                                <img src="{{url('images/program-img3.jpg')}}" class="img-responsive" alt="program">
                            </div>
                            <div class="col-md-10 col-sm-10">
                                <h6>
                        ...
                        <div role="tabpanel" class="tab-pane" id="sday">
                            <!-- program speaker here -->
                            <div class="col-md-2 col-sm-2">
                                <img src="{{url('images/program-img4.jpg')}}" class="img-responsive" alt="program">
                            </div>
                            <div class="col-md-10 col-sm-10">
                                <h6>
                                    <span><i class="fa fa-clock-o"></i> 11.00 AM</span>
                            ...
                            <!-- program speaker here -->
                            <div class="col-md-2 col-sm-2">
                                <img src="{{url('images/program-img5.jpg')}}" class="img-responsive" alt="program">
                            </div>
                            <div class="col-md-10 col-sm-10">
                                <h6>
                            ...
                            <!-- program speaker here -->
                            <div class="col-md-2 col-sm-2">
                                <img src="{{url('images/program-img6.jpg')}}" class="img-responsive" alt="program">
                            </div>
                            <div class="col-md-10 col-sm-10">
                                <h6>
                        ...
                        <div role="tabpanel" class="tab-pane" id="tday">
                            <!-- program speaker here -->
                            <div class="col-md-2 col-sm-2">
                                <img src="{{url('images/program-img7.jpg')}}" class="img-responsive" alt="program">
                            </div>
                            <div class="col-md-10 col-sm-10">
                                <h6>
                                    <span><i class="fa fa-clock-o"></i> 03.00 PM</span>
                            ...
                            <!-- program speaker here -->
                            <div class="col-md-2 col-sm-2">
                                <img src="{{url('images/program-img8.jpg')}}" class="img-responsive" alt="program">
                            </div>
                            <div class="col-md-10 col-sm-10">
                                <h6>
                            ...
                            <!-- program speaker here -->
                            <div class="col-md-2 col-sm-2">
                                <img src="{{url('images/program-img9.jpg')}}" class="img-responsive" alt="program">
                            </div>
                            <div class="col-md-10 col-sm-10">
                                <h6>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="wow fadeInUp col-md-3 col-sm-6 col-xs-6" data-wow-delay="0.3s">
                    <img src="{{url('images/sponsor-img1.jpg')}}" class="img-responsive" alt="sponsors">
                </div>

                <div class="wow fadeInUp col-md-3 col-sm-6 col-xs-6" data-wow-delay="0.6s">
                    <img src="{{url('images/sponsor-img2.jpg')}}" class="img-responsive" alt="sponsors">
                </div>

                <div class="wow fadeInUp col-md-3 col-sm-6 col-xs-6" data-wow-delay="0.9s">
                    <img src="{{url('images/sponsor-img3.jpg')}}" class="img-responsive" alt="sponsors">
                </div>

                <div class="wow fadeInUp col-md-3 col-sm-6 col-xs-6" data-wow-delay="1s">
                    <img src="{{url('images/sponsor-img4.jpg')}}" class="img-responsive" alt="sponsors">
                </div>
